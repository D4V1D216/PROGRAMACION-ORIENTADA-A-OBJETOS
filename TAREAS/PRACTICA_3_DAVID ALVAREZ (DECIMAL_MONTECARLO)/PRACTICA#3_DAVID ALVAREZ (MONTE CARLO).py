#CLASE 3 DE JUNIO DEL 2025 POO
# 4*(p.dentro/p.fuera)= el valor de pi
...
##PASO1:
##-grafico x,y variable
##-circunferencia con variable radio
...
final=time.time()
print(round((final-inicio),4),'segundos')
